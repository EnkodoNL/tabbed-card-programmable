 ...
 */const Ae=r=>r??u;function Ee(r){if(r.__tabbedCardPatched)return;const t=r.define;r.define=function(e,i){if(r.get(e)){console.debug(`[tabbed-card-programmable] Skipping registration of ${e} as it's already defined`);return}try{t.call(r,e,i)}catch(s){console.warn(`[tabbed-card-programmable] Failed to register ${e}:`,s)}},r.__tabbedCardPatched=!0}Ee(customElements);var Nt,zt;(function(r){r.language="language",r.system="system",r.comma_decimal="comma_decimal",r.decimal_comma="decimal_comma",r.space_comma="space_comma",r.none="none"})(Nt||(Nt={})),function(r){r.language="language",r.system="system",r.am_pm="12",r.twenty_four="24"}(zt||(zt={}));var Se=function(r,t,e,i){i=i||{},e=e??{};var s=new Event(t,{bubbles:i.bubbles===void 0||i.bubbles,cancelable:!!i.cancelable,composed:i.composed===void 0||i.composed});return s.detail=e,r.dispatchEvent(s),s},Ie=Object.defineProperty,Pe=Object.getOwnPropertyDescriptor,W=(r,t,e,i)=>{for(var s=i>1?void 0:i?Pe(t,e):t,o=r.length-1,a;o>=0;o--)(a=r[o])&&(s=(i?a(t,e,s):a(s))||s);return i&&s&&Ie(t,e,s),s};let M=class extends y{constructor(){super(...arguments),this._selectedTabIndex=0}setConfig(r){this._config=r,this.loadCardHelpers()}async loadCardHelpers(){this._helpers=await window.loadCardHelpers()}render(){if(!this.hass||!this._config)return b``;const r=this._config.tabs||[];return b`
    ...
    `}_renderTabConfig(r,t){var i,s;if(!r)return b``;const e=r.attributes||{};return b`
      <div class="tab-config">
        ...
        <ha-textfield
          ...
          .value=${e.label||""}
          .configValue=${"label"}
          @input=${o=>this._valueChangedTabAttribute(o,t)}
        ...
        <ha-formfield label="Stack Icon and Label">
          <ha-switch
            .checked=${e.stacked===!0}
            .configValue=${"stacked"}
            @change=${o=>this._valueChangedTabAttribute(o,t)}
          ></ha-switch>
        </ha-formfield>
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const q=Symbol("isFocusable"),ht=Symbol("privateIsFocusable"),J=Symbol("externalTabIndex"),Y=Symbol("isUpdatingTabIndex"),Z=Symbol("updateTabIndex");function Ge(r){var t,e,i;class s extends r{constructor(){super(...arguments),this[t]=!0,this[e]=null,this[i]=!1}get[q](){return this[ht]}set[q](a){this[q]!==a&&(this[ht]=a,this[Z]())}connectedCallback(){super.connectedCallback(),this[Z]()}attributeChangedCallback(a,n,l){if(a!=="tabindex"){super.attributeChangedCallback(a,n,l);return}if(this.requestUpdate("tabIndex",Number(n??-1)),!this[Y]){if(!this.hasAttribute("tabindex")){this[J]=null,this[Z]();return}this[J]=this.tabIndex}}[(t=ht,e=J,i=Y,Z)](){const a=this[q]?0:-1,n=this[J]??a;this[Y]=!0,this.tabIndex=n,this[Y]=!1}}return h([f({noAccessor:!0})],s.prototype,"tabIndex",void 0),s}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class se extends ${constructor(){super(...arguments),this.inlineIcon=!1}getContentClasses(){return{...super.getContentClasses(),stacked:!this.inlineIcon}}}h([f({type:Boolean,attribute:"inline-icon"})],se.prototype,"inlineIcon",void 0);/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */let yt=class extends Qe{};yt.styles=[ts];yt=h([w("md-icon")],yt);var es=Object.defineProperty,ss=Object.getOwnPropertyDescriptor,x=(r,t,e,i)=>{for(var s=i>1?void 0:i?ss(t,e):t,o=r.length-1,a;o>=0;o--)(a=r[o])&&(s=(i?a(t,e,s):a(s))||s);return i&&s&&es(t,e,s),s};let g=class extends y{constructor(){super(...arguments),this.selectedTabIndex=0,this._hiddenTabs=[],this._disabledTabs=[],this._processedLabels=[],this._styles={"--md-sys-color-primary":"var(--primary-text-color)","--md-sys-color-on-surface-variant":"rgba(var(--rgb-primary-text-color), 0.6)","--md-primary-tab-container-color":"transparent","--md-primary-tab-label-text-font":"var(--app-font-family)","--md-primary-tab-active-indicator-color":"var(--primary-text-color)","--md-primary-tab-icon-color":"rgba(var(--rgb-primary-text-color), 0.6)","--md-primary-tab-active-focus-icon-color":"var(--primary-text-color)","--md-primary-tab-active-focus-label-text-color":"var(--primary-text-color)","--md-primary-tab-label-text-size":"var(--ha-font-size-m)"}}async loadCardHelpers(){this._helpers=await window.loadCardHelpers()}static async getConfigElement(){return document.createElement("tabbed-card-editor")}static getStubConfig(){return{options:{},tabs:[{card:{type:"entity",entity:"sun.sun"},attributes:{label:"Sun"}}]}}setConfig(r){if(!r)throw new Error("No configuration.");this._config=r,this._styles={...this._styles,...this._config.styles},this.loadCardHelpers()}willUpdate(r){var t;r.has("_helpers")&&this._createTabs(this._config),r.has("hass")&&((t=this._tabs)!=null&&t.length)&&this._tabs.forEach(e=>e.card.hass=this.hass)}async _createTabs(r){var i;const t=(i=r==null?void 0:r.options)==null?void 0:i.defaultTabIndex;if(typeof t>"u")this.selectedTabIndex=0;else if(typeof t=="string"){const s=await this.evaluateJinjaTemplate(this.hass,t||"0");this.selectedTabIndex=parseInt(s)||0}else this.selectedTabIndex=isFinite(t)?t:0;this._hiddenTabs=[],this._disabledTabs=[],this._processedLabels=[];const e=await Promise.all(r.tabs.map(async s=>{var l,d,p;let o=!1;((l=s.attributes)==null?void 0:l.hide)!==void 0&&(typeof s.attributes.hide=="string"?o=(await this.evaluateJinjaTemplate(this.hass,s.attributes.hide)).toLowerCase()==="true":o=!!s.attributes.hide),this._hiddenTabs.push(o);let a=!1;((d=s.attributes)==null?void 0:d.disable)!==void 0&&(typeof s.attributes.disable=="string"?a=(await this.evaluateJinjaTemplate(this.hass,s.attributes.disable)).toLowerCase()==="true":a=!!s.attributes.disable),this._disabledTabs.push(a);let n=((p=s==null?void 0:s.attributes)==null?void 0:p.label)||"";if(typeof n=="string"&&n.includes("{%")||n.includes("{{"))try{n=await this.evaluateJinjaTemplate(this.hass,n)}catch(c){console.error(`[tabbed-card-programmable] Error evaluating label template: ${c}`)}return this._processedLabels.push(n),{styles:s==null?void 0:s.styles,attributes:{...r==null?void 0:r.attributes,...s==null?void 0:s.attributes},card:await this._createCard(s.card),processedLabel:n}}));if(this._tabs=e,this._hiddenTabs[this.selectedTabIndex]){const s=this._hiddenTabs.findIndex(o=>!o);s>=0&&(this.selectedTabIndex=s)}if(this._disabledTabs[this.selectedTabIndex]){for(let s=0;s<this._tabs.length;s++)if(!this._hiddenTabs[s]&&!this._disabledTabs[s]){this.selectedTabIndex=s;break}}}async _createCard(r){const t=await this._helpers.createCardElement(r);return t.hass=this.hass,t.addEventListener("ll-rebuild",e=>{e.stopPropagation(),this._rebuildCard(t,r)},{once:!0}),t}async _rebuildCard(r,t){console.log("_rebuildCard: ",r,t);const e=await this._helpers.createCardElement(t);r.replaceWith(e)}async evaluateJinjaTemplate(r,t){return new Promise(e=>{r.connection.subscribeMessage(i=>e(i.result.toString()),{type:"render_template",template:t})})}_onTabChange(r){const t=r.target.activeTabIndex;this._disabledTabs[t]||(this.selectedTabIndex=r.target.activeTabIndex,this.dispatchEvent(new CustomEvent("tabbed-card-change",{detail:{index:this.selectedTabIndex},bubbles:!0,composed:!0})))}render(){var e,i;if(!this.hass||!this._config||!this._helpers||!((e=this._tabs)!=null&&e.length))return b``;const r=this._tabs.map((s,o)=>({tab:s,index:o})).filter(({index:s})=>!this._hiddenTabs[s]);if(r.length===0)return b``;const t=r.findIndex(({index:s})=>s===this.selectedTabIndex);return b`
      ...
      >
        ${r.map(({tab:s,index:o})=>{var a,n,l,d,p;return b`
            <md-primary-tab
              style=${Ae(Ot({...(s==null?void 0:s.styles)||{},...this._disabledTabs[o]?{opacity:"0.5",cursor:"not-allowed","--md-sys-color-primary":"var(--disabled-text-color, rgba(var(--rgb-primary-text-color), 0.5))"}:{}}))}
              ?disabled=${this._disabledTabs[o]}
              ?minWidth=${(a=s==null?void 0:s.attributes)==null?void 0:a.minWidth}
    ...
    `}};x([f({attribute:!1})],g.prototype,"hass",2);x([f()],g.prototype,"selectedTabIndex",2);x([f()],g.prototype,"_helpers",2);x([_()],g.prototype,"_config",2);x([_()],g.prototype,"_tabs",2);x([_()],g.prototype,"_hiddenTabs",2);x([_()],g.prototype,"_disabledTabs",2);x([_()],g.prototype,"_processedLabels",2);x([f()],g.prototype,"_styles",2);g=x([w("tabbed-card-programmable")],g);window.customCards=window.customCards||[];window.customCards.push({type:"tabbed-card-programmable",name:"Tabbed Card Programmable",description:"A tabbed card of cards. Programmable."});
