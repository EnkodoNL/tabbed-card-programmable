 ...
 */const X=globalThis,yt=X.ShadowRoot&&(X.ShadyCSS===void 0||X.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,_t=Symbol(),wt=new WeakMap;let Ut=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==_t)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(yt&&t===void 0){const s=e!==void 0&&e.length===1;s&&(t=wt.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&wt.set(e,t))}return t}toString(){return this.cssText}};const ie=r=>new Ut(typeof r=="string"?r:r+"",void 0,_t),C=(r,...t)=>{const e=r.length===1?r[0]:t.reduce((s,i,o)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+r[o+1],r[0]);return new Ut(e,r,_t)},re=(r,t)=>{if(yt)r.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const s=document.createElement("style"),i=X.litNonce;i!==void 0&&s.setAttribute("nonce",i),s.textContent=e.cssText,r.appendChild(s)}},Tt=yt?r=>r:r=>r instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return ie(e)})(r):r;/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const U=globalThis,et=U.trustedTypes,St=et?et.createPolicy("lit-html",{createHTML:r=>r}):void 0,Vt="$lit$",A=`lit$${Math.random().toFixed(9).slice(2)}$`,jt="?"+A,pe=`<${jt}>`,O=document,V=()=>O.createComment(""),j=r=>r===null||typeof r!="object"&&typeof r!="function",$t=Array.isArray,ue=r=>$t(r)||typeof(r==null?void 0:r[Symbol.iterator])=="function",nt=`[ 	
\f\r]`,D=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,It=/-->/g,Pt=/>/g,I=RegExp(`>|${nt}(?:([^\\s"'>=/]+)(${nt}*=${nt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),kt=/'/g,Ot=/"/g,Bt=/^(?:script|style|textarea|title)$/i,fe=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),m=fe(1),S=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Mt=new WeakMap,P=O.createTreeWalker(O,129);function Ft(r,t){if(!$t(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return St!==void 0?St.createHTML(t):t}const be=(r,t)=>{const e=r.length-1,s=[];let i,o=t===2?"<svg>":t===3?"<math>":"",a=D;for(let n=0;n<e;n++){const l=r[n];let c,p,d=-1,u=0;for(;u<l.length&&(a.lastIndex=u,p=a.exec(l),p!==null);)u=a.lastIndex,a===D?p[1]==="!--"?a=It:p[1]!==void 0?a=Pt:p[2]!==void 0?(Bt.test(p[2])&&(i=RegExp("</"+p[2],"g")),a=I):p[3]!==void 0&&(a=I):a===I?p[0]===">"?(a=i??D,d=-1):p[1]===void 0?d=-2:(d=a.lastIndex-p[2].length,c=p[1],a=p[3]===void 0?I:p[3]==='"'?Ot:kt):a===Ot||a===kt?a=I:a===It||a===Pt?a=D:(a=I,i=void 0);const T=a===I&&r[n+1].startsWith("/>")?" ":"";o+=a===D?l+pe:d>=0?(s.push(c),l.slice(0,d)+Vt+l.slice(d)+A+T):l+A+(d===-2?n:T)}return[Ft(r,o+(r[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]};class B{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let o=0,a=0;const n=t.length-1,l=this.parts,[c,p]=be(t,e);if(this.el=B.createElement(c,s),P.currentNode=this.el.content,e===2||e===3){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(i=P.nextNode())!==null&&l.length<n;){if(i.nodeType===1){if(i.hasAttributes())for(const d of i.getAttributeNames())if(d.endsWith(Vt)){const u=p[a++],T=i.getAttribute(d).split(A),Y=/([.?@])?(.*)/.exec(u);l.push({type:1,index:o,name:Y[2],strings:T,ctor:Y[1]==="."?ve:Y[1]==="?"?ge:Y[1]==="@"?ye:it}),i.removeAttribute(d)}else d.startsWith(A)&&(l.push({type:6,index:o}),i.removeAttribute(d));if(Bt.test(i.tagName)){const d=i.textContent.split(A),u=d.length-1;if(u>0){i.textContent=et?et.emptyScript:"";for(let T=0;T<u;T++)i.append(d[T],V()),P.nextNode(),l.push({type:2,index:++o});i.append(d[u],V())}}}else if(i.nodeType===8)if(i.data===jt)l.push({type:2,index:o});else{let d=-1;for(;(d=i.data.indexOf(A,d+1))!==-1;)l.push({type:7,index:o}),d+=A.length-1}o++}}static createElement(t,e){const s=O.createElement("template");return s.innerHTML=t,s}}function L(r,t,e=r,s){var a,n;if(t===S)return t;let i=s!==void 0?(a=e._$Co)==null?void 0:a[s]:e._$Cl;const o=j(t)?void 0:t._$litDirective$;return(i==null?void 0:i.constructor)!==o&&((n=i==null?void 0:i._$AO)==null||n.call(i,!1),o===void 0?i=void 0:(i=new o(r),i._$AT(r,e,s)),s!==void 0?(e._$Co??(e._$Co=[]))[s]=i:e._$Cl=i),i!==void 0&&(t=L(r,i._$AS(r,t.values),i,s)),t}class me{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=((t==null?void 0:t.creationScope)??O).importNode(e,!0);P.currentNode=i;let o=P.nextNode(),a=0,n=0,l=s[0];for(;l!==void 0;){if(a===l.index){let c;l.type===2?c=new F(o,o.nextSibling,this,t):l.type===1?c=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(c=new _e(o,this,t)),this._$AV.push(c),l=s[++n]}a!==(l==null?void 0:l.index)&&(o=P.nextNode(),a++)}return P.currentNode=O,i}p(t){let e=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class F{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=(i==null?void 0:i.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=L(this,t,e),j(t)?t===f||t==null||t===""?(this._$AH!==f&&this._$AR(),this._$AH=f):t!==this._$AH&&t!==S&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ue(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==f&&j(this._$AH)?this._$AA.nextSibling.data=t:this.T(O.createTextNode(t)),this._$AH=t}$(t){var o;const{values:e,_$litType$:s}=t,i=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=B.createElement(Ft(s.h,s.h[0]),this.options)),s);if(((o=this._$AH)==null?void 0:o._$AD)===i)this._$AH.p(e);else{const a=new me(i,this),n=a.u(this.options);a.p(e),this.T(n),this._$AH=a}}_$AC(t){let e=Mt.get(t.strings);return e===void 0&&Mt.set(t.strings,e=new B(t)),e}k(t){$t(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const o of t)i===e.length?e.push(s=new F(this.O(V()),this.O(V()),this,this.options)):s=e[i],s._$AI(o),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,e);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}}class it{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,o){this.type=1,this._$AH=f,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=f}_$AI(t,e=this,s,i){const o=this.strings;let a=!1;if(o===void 0)t=L(this,t,e,0),a=!j(t)||t!==this._$AH&&t!==S,a&&(this._$AH=t);else{const n=t;let l,c;for(t=o[0],l=0;l<o.length-1;l++)c=L(this,n[s+l],e,l),c===S&&(c=this._$AH[l]),a||(a=!j(c)||c!==this._$AH[l]),c===f?t=f:t!==f&&(t+=(c??"")+o[l+1]),this._$AH[l]=c}a&&!i&&this.j(t)}j(t){t===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class ve extends it{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===f?void 0:t}}class ge extends it{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==f)}}class ye extends it{constructor(t,e,s,i,o){super(t,e,s,i,o),this.type=5}_$AI(t,e=this){if((t=L(this,t,e,0)??f)===S)return;const s=this._$AH,i=t===f&&s!==f||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==f&&(s===f||i);i&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class _e{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){L(this,t)}}const lt=U.litHtmlPolyfillSupport;lt==null||lt(B,F),(U.litHtmlVersions??(U.litHtmlVersions=[])).push("3.3.0");const xe=(r,t,e)=>{const s=(e==null?void 0:e.renderBefore)??t;let i=s._$litPart$;if(i===void 0){const o=(e==null?void 0:e.renderBefore)??null;s._$litPart$=i=new F(t.insertBefore(V(),o),o,void 0,e??{})}return i._$AI(r),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const k=globalThis;let g=class extends N{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=xe(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return S}};var Ht;g._$litElement$=!0,g.finalized=!0,(Ht=k.litElementHydrateSupport)==null||Ht.call(k,{LitElement:g});const ct=k.litElementPolyfillSupport;ct==null||ct({LitElement:g});(k.litElementVersions??(k.litElementVersions=[])).push("4.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function rt(r,t){return(e,s,i)=>{const o=a=>{var n;return((n=a.renderRoot)==null?void 0:n.querySelector(r))??null};if(t){const{get:a,set:n}=typeof s=="object"?e:i??(()=>{const l=Symbol();return{get(){return this[l]},set(c){this[l]=c}}})();return st(e,s,{get(){let l=a.call(this);return l===void 0&&(l=o(this),(l!==null||this.hasUpdated)&&n.call(this,l)),l}})}return st(e,s,{get(){return o(this)}})}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Wt(r){return(t,e)=>{const{slot:s,selector:i}=r??{},o="slot"+(s?`[name=${s}]`:":not([name])");return st(t,e,{get(){var l;const a=(l=this.renderRoot)==null?void 0:l.querySelector(o),n=(a==null?void 0:a.assignedElements(r))??[];return i===void 0?n:n.filter(c=>c.matches(i))}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Ae=r=>r??f;function Ee(r){if(r.__tabbedCardPatched)return;const t=r.define;r.define=function(e,s){if(r.get(e)){console.debug(`[tabbed-card-programmable] Skipping registration of ${e} as it's already defined`);return}try{t.call(r,e,s)}catch(i){console.warn(`[tabbed-card-programmable] Failed to register ${e}:`,i)}},r.__tabbedCardPatched=!0}Ee(customElements);var Nt,Lt;(function(r){r.language="language",r.system="system",r.comma_decimal="comma_decimal",r.decimal_comma="decimal_comma",r.space_comma="space_comma",r.none="none"})(Nt||(Nt={})),function(r){r.language="language",r.system="system",r.am_pm="12",r.twenty_four="24"}(Lt||(Lt={}));var Se=function(r,t,e,s){s=s||{},e=e??{};var i=new Event(t,{bubbles:s.bubbles===void 0||s.bubbles,cancelable:!!s.cancelable,composed:s.composed===void 0||s.composed});return i.detail=e,r.dispatchEvent(i),i},Ie=Object.defineProperty,Pe=Object.getOwnPropertyDescriptor,W=(r,t,e,s)=>{for(var i=s>1?void 0:s?Pe(t,e):t,o=r.length-1,a;o>=0;o--)(a=r[o])&&(i=(s?a(t,e,i):a(i))||i);return s&&i&&Ie(t,e,i),i};let M=class extends g{constructor(){super(...arguments),this._selectedTabIndex=0}setConfig(r){this._config=r,this.loadCardHelpers()}async loadCardHelpers(){this._helpers=await window.loadCardHelpers()}render(){if(!this.hass||!this._config)return m``;const r=this._config.tabs||[];return m`
    ...
    `}_renderGlobalConfig(){var t;const r=((t=this._config)==null?void 0:t.options)||{};return m`
    ...
    `}_renderTabConfig(r,t){if(!r)return m``;const e=r.attributes||{};return m`
...
# Please edit manually`}}_handleCodeEditorChanged(r,t){if(!this._config||!this.hass||!this._config.tabs)return;const e=r.detail.value;try{let s;window.jsyaml&&window.jsyaml.load?s=window.jsyaml.load(e):s=JSON.parse(e);const i=[...this._config.tabs],o={...i[t]};o.card=s,i[t]=o,this._updateConfig({...this._config,tabs:i})}catch(s){console.error("Invalid YAML:",s)}}_handleYamlChanged(r,t){if(!this._config||!this.hass||!this._config.tabs)return;const s=r.target.value;try{let i;window.jsyaml&&window.jsyaml.load?i=window.jsyaml.load(s):i=JSON.parse(s);const o=[...this._config.tabs],a={...o[t]};a.card=i,o[t]=a,this._updateConfig({...this._config,tabs:o})}catch(i){console.error("Invalid YAML:",i)}}_validateYaml(){alert("YAML validation is not yet implemented. Please ensure your YAML is valid.")}_updateConfig(r){this._config=r,Se(this,"config-changed",{config:r})}};M.styles=C`
  ...
  `;W([b({attribute:!1})],M.prototype,"hass",2);W([_()],M.prototype,"_config",2);W([_()],M.prototype,"_helpers",2);W([_()],M.prototype,"_selectedTabIndex",2);M=W([w("tabbed-card-editor")],M);function h(r,t,e,s){var i=arguments.length,o=i<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,e):s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,t,e,s);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(o=(i<3?a(o):i>3?a(t,e,o):a(t,e))||o);return i>3&&o&&Object.defineProperty(t,e,o),o}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class ot extends g{constructor(){super(...arguments),this.inset=!1,this.insetStart=!1,this.insetEnd=!1}}h([b({type:Boolean,reflect:!0})],ot.prototype,"inset",void 0);h([b({type:Boolean,reflect:!0,attribute:"inset-start"})],ot.prototype,"insetStart",void 0);h([b({type:Boolean,reflect:!0,attribute:"inset-end"})],ot.prototype,"insetEnd",void 0);/**
 * @license
 ...
 * SPDX-License-Identifier: Apache-2.0
 */class Oe extends g{connectedCallback(){super.connectedCallback(),this.setAttribute("aria-hidden","true")}render(){return m`<span class="shadow"></span>`}}/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */let ut=class extends Oe{};ut.styles=[Me];ut=h([w("md-elevation")],ut);/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Re=["focusin","focusout","pointerdown"];class Ct extends g{constructor(){super(...arguments),this.visible=!1,this.inward=!1,this.attachableController=new Zt(this,this.onControlChange.bind(this))}get htmlFor(){return this.attachableController.htmlFor}set htmlFor(t){this.attachableController.htmlFor=t}get control(){return this.attachableController.control}set control(t){this.attachableController.control=t}attach(t){this.attachableController.attach(t)}detach(){this.attachableController.detach()}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-hidden","true")}handleEvent(t){var e;if(!t[zt]){switch(t.type){default:return;case"focusin":this.visible=((e=this.control)==null?void 0:e.matches(":focus-visible"))??!1;break;case"focusout":case"pointerdown":this.visible=!1;break}t[zt]=!0}}onControlChange(t,e){for(const s of Re)t==null||t.removeEventListener(s,this),e==null||e.addEventListener(s,this)}update(t){t.has("visible")&&this.dispatchEvent(new Event("visibility-changed")),super.update(t)}}h([b({type:Boolean,reflect:!0})],Ct.prototype,"visible",void 0);h([b({type:Boolean,reflect:!0})],Ct.prototype,"inward",void 0);const zt=Symbol("handledByFocusRing");/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Le=450,Dt=225,ze=.2,De=10,He=75,Ue=.35,Ve="::after",je="forwards";var v;(function(r){r[r.INACTIVE=0]="INACTIVE",r[r.TOUCH_DELAY=1]="TOUCH_DELAY",r[r.HOLDING=2]="HOLDING",r[r.WAITING_FOR_CLICK=3]="WAITING_FOR_CLICK"})(v||(v={}));const Be=["click","contextmenu","pointercancel","pointerdown","pointerenter","pointerleave","pointerup"],Fe=150,dt=window.matchMedia("(forced-colors: active)");class G extends g{constructor(){super(...arguments),this.disabled=!1,this.hovered=!1,this.pressed=!1,this.rippleSize="",this.rippleScale="",this.initialSize=0,this.state=v.INACTIVE,this.checkBoundsAfterContextMenu=!1,this.attachableController=new Zt(this,this.onControlChange.bind(this))}get htmlFor(){return this.attachableController.htmlFor}set htmlFor(t){this.attachableController.htmlFor=t}get control(){return this.attachableController.control}set control(t){this.attachableController.control=t}attach(t){this.attachableController.attach(t)}detach(){this.attachableController.detach()}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-hidden","true")}render(){const t={hovered:this.hovered,pressed:this.pressed};return m`<div class="surface ${Xt(t)}"></div>`}update(t){t.has("disabled")&&this.disabled&&(this.hovered=!1,this.pressed=!1),super.update(t)}handlePointerenter(t){this.shouldReactToEvent(t)&&(this.hovered=!0)}handlePointerleave(t){this.shouldReactToEvent(t)&&(this.hovered=!1,this.state!==v.INACTIVE&&this.endPressAnimation())}handlePointerup(t){if(this.shouldReactToEvent(t)){if(this.state===v.HOLDING){this.state=v.WAITING_FOR_CLICK;return}if(this.state===v.TOUCH_DELAY){this.state=v.WAITING_FOR_CLICK,this.startPressAnimation(this.rippleStartEvent);return}}}async handlePointerdown(t){if(this.shouldReactToEvent(t)){if(this.rippleStartEvent=t,!this.isTouch(t)){this.state=v.WAITING_FOR_CLICK,this.startPressAnimation(t);return}this.checkBoundsAfterContextMenu&&!this.inBounds(t)||(this.checkBoundsAfterContextMenu=!1,this.state=v.TOUCH_DELAY,await new Promise(e=>{setTimeout(e,Fe)}),this.state===v.TOUCH_DELAY&&(this.state=v.HOLDING,this.startPressAnimation(t)))}}handleClick(){if(!this.disabled){if(this.state===v.WAITING_FOR_CLICK){this.endPressAnimation();return}this.state===v.INACTIVE&&(this.startPressAnimation(),this.endPressAnimation())}}handlePointercancel(t){this.shouldReactToEvent(t)&&this.endPressAnimation()}handleContextmenu(){this.disabled||(this.checkBoundsAfterContextMenu=!0,this.endPressAnimation())}determineRippleSize(){const{height:t,width:e}=this.getBoundingClientRect(),s=Math.max(t,e),i=Math.max(Ue*s,He),o=Math.floor(s*ze),n=Math.sqrt(e**2+t**2)+De;this.initialSize=o,this.rippleScale=`${(n+i)/o}`,this.rippleSize=`${o}px`}getNormalizedPointerEventCoords(t){const{scrollX:e,scrollY:s}=window,{left:i,top:o}=this.getBoundingClientRect(),a=e+i,n=s+o,{pageX:l,pageY:c}=t;return{x:l-a,y:c-n}}getTranslationCoordinates(t){const{height:e,width:s}=this.getBoundingClientRect(),i={x:(s-this.initialSize)/2,y:(e-this.initialSize)/2};let o;return t instanceof PointerEvent?o=this.getNormalizedPointerEventCoords(t):o={x:s/2,y:e/2},o={x:o.x-this.initialSize/2,y:o.y-this.initialSize/2},{startPoint:o,endPoint:i}}startPressAnimation(t){var a;if(!this.mdRoot)return;this.pressed=!0,(a=this.growAnimation)==null||a.cancel(),this.determineRippleSize();const{startPoint:e,endPoint:s}=this.getTranslationCoordinates(t),i=`${e.x}px, ${e.y}px`,o=`${s.x}px, ${s.y}px`;this.growAnimation=this.mdRoot.animate({top:[0,0],left:[0,0],height:[this.rippleSize,this.rippleSize],width:[this.rippleSize,this.rippleSize],transform:[`translate(${i}) scale(1)`,`translate(${o}) scale(${this.rippleScale})`]},{pseudoElement:Ve,duration:Le,easing:Qt.STANDARD,fill:je})}async endPressAnimation(){this.rippleStartEvent=void 0,this.state=v.INACTIVE;const t=this.growAnimation;let e=1/0;if(typeof(t==null?void 0:t.currentTime)=="number"?e=t.currentTime:t!=null&&t.currentTime&&(e=t.currentTime.to("ms").value),e>=Dt){this.pressed=!1;return}await new Promise(s=>{setTimeout(s,Dt-e)}),this.growAnimation===t&&(this.pressed=!1)}shouldReactToEvent(t){if(this.disabled||!t.isPrimary||this.rippleStartEvent&&this.rippleStartEvent.pointerId!==t.pointerId)return!1;if(t.type==="pointerenter"||t.type==="pointerleave")return!this.isTouch(t);const e=t.buttons===1;return this.isTouch(t)||e}inBounds({x:t,y:e}){const{top:s,left:i,bottom:o,right:a}=this.getBoundingClientRect();return t>=i&&t<=a&&e>=s&&e<=o}isTouch({pointerType:t}){return t==="touch"}async handleEvent(t){if(!(dt!=null&&dt.matches))switch(t.type){case"click":this.handleClick();break;case"contextmenu":this.handleContextmenu();break;case"pointercancel":this.handlePointercancel(t);break;case"pointerdown":await this.handlePointerdown(t);break;case"pointerenter":this.handlePointerenter(t);break;case"pointerleave":this.handlePointerleave(t);break;case"pointerup":this.handlePointerup(t);break}}onControlChange(t,e){for(const s of Be)t==null||t.removeEventListener(s,this),e==null||e.addEventListener(s,this)}}h([b({type:Boolean,reflect:!0})],G.prototype,"disabled",void 0);h([_()],G.prototype,"hovered",void 0);h([_()],G.prototype,"pressed",void 0);h([rt(".surface")],G.prototype,"mdRoot",void 0);/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class se extends x{constructor(){super(...arguments),this.inlineIcon=!1}getContentClasses(){return{...super.getContentClasses(),stacked:!this.inlineIcon}}}h([b({type:Boolean,attribute:"inline-icon"})],se.prototype,"inlineIcon",void 0);/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class Qe extends g{render(){return m`<slot></slot>`}connectedCallback(){if(super.connectedCallback(),this.getAttribute("aria-hidden")==="false"){this.removeAttribute("aria-hidden");return}this.setAttribute("aria-hidden","true")}}/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */let gt=class extends Qe{};gt.styles=[ts];gt=h([w("md-icon")],gt);var es=Object.defineProperty,ss=Object.getOwnPropertyDescriptor,$=(r,t,e,s)=>{for(var i=s>1?void 0:s?ss(t,e):t,o=r.length-1,a;o>=0;o--)(a=r[o])&&(i=(s?a(t,e,i):a(i))||i);return s&&i&&es(t,e,i),i};let y=class extends g{constructor(){super(...arguments),this.selectedTabIndex=0,this._hiddenTabs=[],this._disabledTabs=[],this._processedLabels=[],this._styles={"--md-sys-color-primary":"var(--primary-text-color)","--md-sys-color-on-surface-variant":"rgba(var(--rgb-primary-text-color), 0.6)","--md-primary-tab-container-color":"transparent","--md-primary-tab-label-text-font":"var(--app-font-family)","--md-primary-tab-active-indicator-color":"var(--primary-text-color)","--md-primary-tab-icon-color":"rgba(var(--rgb-primary-text-color), 0.6)","--md-primary-tab-active-focus-icon-color":"var(--primary-text-color)","--md-primary-tab-active-focus-label-text-color":"var(--primary-text-color)","--md-primary-tab-label-text-size":"var(--ha-font-size-m)"}}async loadCardHelpers(){this._helpers=await window.loadCardHelpers()}static async getConfigElement(){return document.createElement("tabbed-card-editor")}static getStubConfig(){return{options:{},tabs:[{card:{type:"entity",entity:"sun.sun"},attributes:{label:"Sun"}}]}}setConfig(r){if(!r)throw new Error("No configuration.");this._config=r,this._styles={...this._styles,...this._config.styles},this.loadCardHelpers()}willUpdate(r){var t;r.has("_helpers")&&this._createTabs(this._config),r.has("hass")&&((t=this._tabs)!=null&&t.length)&&this._tabs.forEach(e=>e.card.hass=this.hass)}async _createTabs(r){var s;console.log("_createTabs called with config:",JSON.stringify(r,null,2));const t=(s=r==null?void 0:r.options)==null?void 0:s.defaultTabIndex;if(typeof t>"u")this.selectedTabIndex=0;else if(typeof t=="string"){const i=await this.evaluateJinjaTemplate(this.hass,t||"0");this.selectedTabIndex=parseInt(i)||0}else this.selectedTabIndex=isFinite(t)?t:0;console.log("Initial selectedTabIndex:",this.selectedTabIndex),this._hiddenTabs=[],this._disabledTabs=[],this._processedLabels=[];const e=await Promise.all(r.tabs.map(async(i,o)=>{var c,p,d;console.log(`Processing tab ${o}:`,JSON.stringify(i.attributes,null,2));let a=!1;if(((c=i.attributes)==null?void 0:c.hide)!==void 0)if(typeof i.attributes.hide=="string"){const u=await this.evaluateJinjaTemplate(this.hass,i.attributes.hide);a=u.toLowerCase()==="true",console.log(`Tab ${o} hide (string):`,i.attributes.hide,"->",u,"->",a)}else a=!!i.attributes.hide,console.log(`Tab ${o} hide (boolean):`,i.attributes.hide,"->",a);else console.log(`Tab ${o} hide: undefined -> false`);this._hiddenTabs.push(a);let n=!1;if(((p=i.attributes)==null?void 0:p.disable)!==void 0)if(typeof i.attributes.disable=="string"){const u=await this.evaluateJinjaTemplate(this.hass,i.attributes.disable);n=u.toLowerCase()==="true",console.log(`Tab ${o} disable (string):`,i.attributes.disable,"->",u,"->",n)}else n=!!i.attributes.disable,console.log(`Tab ${o} disable (boolean):`,i.attributes.disable,"->",n);else console.log(`Tab ${o} disable: undefined -> false`);this._disabledTabs.push(n);let l=((d=i==null?void 0:i.attributes)==null?void 0:d.label)||"";if(typeof l=="string"&&l.includes("{%")||l.includes("{{"))try{l=await this.evaluateJinjaTemplate(this.hass,l)}catch(u){console.error(`[tabbed-card-programmable] Error evaluating label template: ${u}`)}return this._processedLabels.push(l),{styles:i==null?void 0:i.styles,attributes:i==null?void 0:i.attributes,card:await this._createCard(i.card),processedLabel:l}}));if(this._tabs=e,this._hiddenTabs[this.selectedTabIndex]){const i=this._hiddenTabs.findIndex(o=>!o);i>=0&&(this.selectedTabIndex=i)}if(this._disabledTabs[this.selectedTabIndex]){for(let i=0;i<this._tabs.length;i++)if(!this._hiddenTabs[i]&&!this._disabledTabs[i]){this.selectedTabIndex=i;break}}}async _createCard(r){const t=await this._helpers.createCardElement(r);return t.hass=this.hass,t.addEventListener("ll-rebuild",e=>{e.stopPropagation(),this._rebuildCard(t,r)},{once:!0}),t}async _rebuildCard(r,t){console.log("_rebuildCard: ",r,t);const e=await this._helpers.createCardElement(t);r.replaceWith(e)}async evaluateJinjaTemplate(r,t){return new Promise(e=>{r.connection.subscribeMessage(s=>e(s.result.toString()),{type:"render_template",template:t})})}_onTabChange(r){var i;console.log("_onTabChange called with event:",r);const t=r.target.activeTabIndex;console.log("newVisibleIndex:",t);const e=this._tabs.map((o,a)=>({tab:o,index:a})).filter(({index:o})=>!this._hiddenTabs[o]);console.log("visibleTabs indices:",e.map(({index:o})=>o));const s=(i=e[t])==null?void 0:i.index;if(console.log("newOriginalIndex:",s),console.log("_disabledTabs array:",this._disabledTabs),s===void 0){console.log("newOriginalIndex is undefined, returning");return}if(this._disabledTabs[s]){console.log(`Tab ${s} is disabled, not changing selected tab`);return}console.log(`Setting selectedTabIndex from ${this.selectedTabIndex} to ${s}`),this.selectedTabIndex=s,this.dispatchEvent(new CustomEvent("tabbed-card-change",{detail:{index:this.selectedTabIndex},bubbles:!0,composed:!0}))}render(){var e;if(console.log("render called"),!this.hass||!this._config||!this._helpers||!((e=this._tabs)!=null&&e.length))return console.log("Missing required properties, returning empty"),m``;console.log("_hiddenTabs array:",this._hiddenTabs),console.log("_disabledTabs array:",this._disabledTabs),console.log("selectedTabIndex:",this.selectedTabIndex);const r=this._tabs.map((s,i)=>({tab:s,index:i})).filter(({index:s})=>!this._hiddenTabs[s]);if(console.log("visibleTabs:",r.map(({index:s})=>s)),r.length===0)return console.log("No visible tabs, returning empty"),m``;const t=r.findIndex(({index:s})=>s===this.selectedTabIndex);return console.log("activeVisibleIndex:",t),m`
      <md-tabs
        @change=${this._onTabChange}
        style=${Rt(this._styles)}
        .activeTabIndex=${t>=0?t:0}
      >
        ${r.map(({tab:s,index:i})=>{var o,a,n,l,c;return console.log(`Rendering tab with original index ${i}:`),console.log(`  - Label: ${(o=s==null?void 0:s.attributes)==null?void 0:o.label}`),console.log(`  - Is disabled: ${this._disabledTabs[i]}`),m`
            <md-primary-tab
              style=${Ae(Rt({...(s==null?void 0:s.styles)||{},...this._disabledTabs[i]?{opacity:"0.5",cursor:"not-allowed","--md-sys-color-primary":"var(--disabled-text-color, rgba(var(--rgb-primary-text-color), 0.5))"}:{}}))}
              ?disabled=${this._disabledTabs[i]}
              ?inline-icon=${!((a=s==null?void 0:s.attributes)!=null&&a.stacked)}
            >
              ${(n=s==null?void 0:s.attributes)!=null&&n.icon?m`<ha-icon
                    slot="icon"
                    icon="${(l=s==null?void 0:s.attributes)==null?void 0:l.icon}"
                  ></ha-icon>`:m``}
              <span
                >${(s==null?void 0:s.processedLabel)||((c=s==null?void 0:s.attributes)==null?void 0:c.label)||f}</span
              >
            </md-primary-tab>
          `})}
      </md-tabs>
      <section>
        <article>
          ${(()=>{var s;return console.log(`Rendering card for tab index ${this.selectedTabIndex}`),(s=this._tabs.find((i,o)=>o==this.selectedTabIndex))==null?void 0:s.card})()}
        </article>
      </section>
    `}};$([b({attribute:!1})],y.prototype,"hass",2);$([b()],y.prototype,"selectedTabIndex",2);$([b()],y.prototype,"_helpers",2);$([_()],y.prototype,"_config",2);$([_()],y.prototype,"_tabs",2);$([_()],y.prototype,"_hiddenTabs",2);$([_()],y.prototype,"_disabledTabs",2);$([_()],y.prototype,"_processedLabels",2);$([b()],y.prototype,"_styles",2);y=$([w("tabbed-card-programmable")],y);window.customCards=window.customCards||[];window.customCards.push({type:"tabbed-card-programmable",name:"Tabbed Card Programmable",description:"A tabbed card of cards. Programmable."});
